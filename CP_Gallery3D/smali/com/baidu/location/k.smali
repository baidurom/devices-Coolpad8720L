...
.field private static else:Landroid/location/Location;
...
.field private static long:Ljava/util/ArrayList;

.field private static new:Ljava/util/ArrayList;

.field private static try:Landroid/location/Location;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/baidu/location/k;->char:Ljava/lang/String;
    ...
    sput-object v0, Lcom/baidu/location/k;->new:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/baidu/location/k;->e:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/baidu/location/k;->g:Ljava/lang/String;

    sput-object v2, Lcom/baidu/location/k;->b:Ljava/io/File;

    sput v3, Lcom/baidu/location/k;->case:I
    ...
    sput v0, Lcom/baidu/location/k;->h:I

    const/4 v0, 0x5

    sput v0, Lcom/baidu/location/k;->byte:I

    sput v3, Lcom/baidu/location/k;->i:I

    const/16 v0, 0x100

    sput v0, Lcom/baidu/location/k;->f:I
    ...
    sput-wide v0, Lcom/baidu/location/k;->goto:D

    const-wide/high16 v0, 0x4059

    sput-wide v0, Lcom/baidu/location/k;->c:D
    ...
    sput v0, Lcom/baidu/location/k;->void:I

    const/16 v0, 0x80

    sput v0, Lcom/baidu/location/k;->for:I

    sput-object v2, Lcom/baidu/location/k;->else:Landroid/location/Location;

    sput-object v2, Lcom/baidu/location/k;->try:Landroid/location/Location;
...
.method private static a(IIIJ)I
    ...
    :cond_1
    sget-object v1, Lcom/baidu/location/k;->char:Ljava/lang/String;
    ...
    :try_start_0
    sget-object v1, Lcom/baidu/location/k;->b:Ljava/io/File;

    if-nez v1, :cond_3

    new-instance v1, Ljava/io/File;

    sget-object v2, Lcom/baidu/location/k;->g:Ljava/lang/String;

    invoke-direct {v1, v2}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    sput-object v1, Lcom/baidu/location/k;->b:Ljava/io/File;
    ...
    sget-object v2, Lcom/baidu/location/f;->M:Ljava/lang/String;
    ...
    sget-object v2, Lcom/baidu/location/k;->b:Ljava/io/File;
    ...
    :cond_4
    :try_start_1
    sget-object v0, Lcom/baidu/location/k;->char:Ljava/lang/String;
    ...
    sput-object v0, Lcom/baidu/location/k;->b:Ljava/io/File;
    :try_end_1
...
.method private static a(Ljava/util/List;I)I
    ...
    :cond_1
    :try_start_0
    sget-object v0, Lcom/baidu/location/k;->b:Ljava/io/File;

    if-nez v0, :cond_2

    new-instance v0, Ljava/io/File;

    sget-object v1, Lcom/baidu/location/k;->g:Ljava/lang/String;
    ...
    sget v6, Lcom/baidu/location/k;->h:I
    ...
    sget v0, Lcom/baidu/location/k;->h:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a()Ljava/lang/String;
    ...
    sget-object v1, Lcom/baidu/location/k;->long:Ljava/util/ArrayList;
    ...
    sget-object v0, Lcom/baidu/location/k;->long:Ljava/util/ArrayList;
    ...
    sget-object v1, Lcom/baidu/location/k;->new:Ljava/util/ArrayList;
    ...
    sget v2, Lcom/baidu/location/k;->void:I
    ...
    sget-object v0, Lcom/baidu/location/k;->new:Ljava/util/ArrayList;
    ...
    sget-object v1, Lcom/baidu/location/k;->e:Ljava/util/ArrayList;
    ...
    sget v2, Lcom/baidu/location/k;->for:I
    ...
    sget-object v0, Lcom/baidu/location/k;->e:Ljava/util/ArrayList;
...
.method public static a(DDDD)V
    ...
    :goto_0
    sput-wide p0, Lcom/baidu/location/k;->d:D
    ...
    :goto_1
    sput-wide p4, Lcom/baidu/location/k;->goto:D

    sput-wide p6, Lcom/baidu/location/k;->c:D

    return-void

    :cond_0
    sget-wide p0, Lcom/baidu/location/k;->d:D

    goto :goto_0

    :cond_1
    sget-wide p4, Lcom/baidu/location/k;->goto:D
...
.method public static a(Lcom/baidu/location/c$a;Lcom/baidu/location/e$c;Landroid/location/Location;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/baidu/location/c$a;->if()Z
    ...
    sput-object p2, Lcom/baidu/location/k;->try:Landroid/location/Location;

    sput-object p2, Lcom/baidu/location/k;->else:Landroid/location/Location;
    ...
    invoke-static {p2}, Lcom/baidu/location/k;->if(Landroid/location/Location;)Z
    ...
    invoke-static {p0, v0, p2, p3, v1}, Lcom/baidu/location/j;->a(Lcom/baidu/location/c$a;Lcom/baidu/location/e$c;Landroid/location/Location;Ljava/lang/String;I)Ljava/lang/String;
...
.method private static a(Ljava/lang/String;)V
    ...
    sget v1, Lcom/baidu/location/k;->h:I
    ...
    sget v1, Lcom/baidu/location/k;->void:I
    ...
    sget v0, Lcom/baidu/location/k;->void:I

    sget v1, Lcom/baidu/location/k;->i:I

    sget v2, Lcom/baidu/location/k;->if:I

    sget v3, Lcom/baidu/location/k;->f:I

    sget v4, Lcom/baidu/location/k;->i:I
...
.method private static a(Landroid/location/Location;)Z
    ...
    :cond_1
    sget-object v2, Lcom/baidu/location/k;->do:Landroid/location/Location;
    ...
    sget-wide v4, Lcom/baidu/location/k;->c:D
...
.method private static do(Ljava/lang/String;)V
    ...
    sget v1, Lcom/baidu/location/k;->for:I
    ...
    sget v0, Lcom/baidu/location/k;->for:I

    sget v1, Lcom/baidu/location/k;->i:I

    sget v2, Lcom/baidu/location/k;->case:I
...
.method public static do(Landroid/location/Location;)Z
    .locals 1

    sget-object v0, Lcom/baidu/location/k;->else:Landroid/location/Location;

    invoke-static {v0, p0}, Lcom/baidu/location/b;->a(Landroid/location/Location;Landroid/location/Location;)Z
...
.method private static if(Landroid/location/Location;)Z
    ...
    :cond_1
    sget-object v2, Lcom/baidu/location/k;->try:Landroid/location/Location;

    if-nez v2, :cond_2

    sput-object p0, Lcom/baidu/location/k;->try:Landroid/location/Location;
    ...
    sget-wide v4, Lcom/baidu/location/k;->d:D

    mul-double/2addr v4, v2

    mul-double/2addr v4, v2

    sget-wide v6, Lcom/baidu/location/k;->a:D

    mul-double/2addr v2, v6

    add-double/2addr v2, v4

    sget-wide v4, Lcom/baidu/location/k;->goto:D

    add-double/2addr v2, v4

    sget-object v4, Lcom/baidu/location/k;->else:Landroid/location/Location;
