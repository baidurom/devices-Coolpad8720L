...
.method public getWakelockList()Ljava/lang/String;
    ...
    invoke-interface {v1}, Landroid/os/IPowerManager;->getWakelockList()Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isRealyScreenOn()Z
    ...
    invoke-interface {v1}, Landroid/os/IPowerManager;->isRealyScreenOn()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public startYLBreathLightFlashTest(III)V
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/os/IPowerManager;->startYLBreathLightFlashTest(III)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public startYLBreathLightTest(I)V
    ...
    invoke-interface {v0, p1}, Landroid/os/IPowerManager;->startYLBreathLightTest(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public stopYLBreathLightTest()V
    ...
    invoke-interface {v0}, Landroid/os/IPowerManager;->stopYLBreathLightTest()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
