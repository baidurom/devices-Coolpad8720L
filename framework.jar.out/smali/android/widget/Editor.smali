...
.method private shouldBlink()Z
    ...
    iget-boolean v3, v3, Landroid/widget/TextView;->mYlCursorVisible:Z
...
.method onDrop(Landroid/view/DragEvent;)V
    ...
    .line 1963
    :cond_1
    const-string v27, "Editor"

    const-string v28, "Editor, onDrop, offset invalid"
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/widget/TextView;->getFilters()[Landroid/text/InputFilter;
    ...
    check-cast v27, Landroid/text/InputFilter$LengthFilter;

    move-object/from16 v0, p0

    move-object/from16 v1, v27

    invoke-direct {v0, v1}, Landroid/widget/Editor;->getInputLengthFilterMax(Landroid/text/InputFilter$LengthFilter;)I
    ...
    .end local v17           #min:I
    .end local v18           #minMax:J
    .end local v22           #originalLength:I
    :cond_7
    const/4 v6, 0x0
    ...
    .restart local v10       #filter:[Landroid/text/InputFilter;
    .restart local v15       #max:I
    .restart local v16       #maxLen:I
    .restart local v17       #min:I
    .restart local v18       #minMax:J
    .restart local v22       #originalLength:I
    :cond_8
    if-lez v16, :cond_9
    ...
    const-string v28, "Editor, onDrop, over the max length"
...
.method onWindowFocusChanged(Z)V
    ...
    iget-boolean v0, v0, Landroid/widget/TextView;->mPopupMenuShow:Z
...
.method prepareCursorControllers()V
    ...
    iget-boolean v6, v6, Landroid/widget/TextView;->mYlCursorVisible:Z
    ...
    iget-boolean v6, v6, Landroid/widget/TextView;->mUseYlSelectionMode:Z
