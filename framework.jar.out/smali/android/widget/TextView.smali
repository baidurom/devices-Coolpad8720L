...
.field private static final ID_SELECTION_MODE:I = #android:id@selectTextMode#t
...
.field private mInternalDiscardNextActionUp:Z
...
.method public bringPointIntoView(I)Z
    ...
    .line 6936
    .local v21, line:I
    sget-object v29, Landroid/widget/TextView$4;->$SwitchMap$android$text$Layout$Alignment:[I
    ...
    invoke-static/range {v29 .. v29}, Landroid/util/FloatMath;->floor(F)F
    ...
    .line 6986
    div-int/lit8 v26, v27, 0x4

    .line 6987
    :cond_3
    div-int/lit8 v29, v17, 0x4
    ...
    invoke-virtual {v0, v15, v1}, Landroid/view/View;->scrollTo(II)V
    ...
    invoke-virtual/range {v29 .. v31}, Landroid/graphics/Rect;->offset(II)V

    .line 7101
    const/4 v4, 0x0

    .line 7102
    .local v4, addedOffset:I
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/widget/Editor$SelectionModifierCursorController;->isSelectionEndDragged()Z
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/widget/Editor$SelectionModifierCursorController;->isSelectionEndDragDown()Z
    ...
    .line 6928
    .end local v4           #addedOffset:I
    .end local v5           #bottom:I
    .end local v7           #clamped:Z
    ...
    .end local v24           #top:I
    .end local v25           #vs:I
    .end local v26           #vslack:I
    .end local v27           #vspace:I
    .end local v28           #x:I
    :cond_12
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v1, v2, v11, v12}, Landroid/widget/Scroller;->startScroll(IIII)V
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/widget/Scroller;->getDuration()I
    ...
    invoke-virtual {v0, v11, v12}, Landroid/view/View;->scrollBy(II)V
    ...
    .end local v11           #dx:I
    .end local v12           #dy:I
    .restart local v4       #addedOffset:I
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/widget/Editor$SelectionModifierCursorController;->isSelectionStartDragged()Z
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/widget/Editor$SelectionModifierCursorController;->isSelectionStartDragDown()Z
...
.method public onTextContextMenuItem(I)Z
    ...
    invoke-virtual {v5}, Landroid/widget/Editor;->hideInsertionPointCursorControllerP()V
    ...
    invoke-virtual {v5}, Landroid/widget/Editor;->selectCurrentWordP()Z
    ...
    .sparse-switch
        ...
        #android:id@selectTextMode#t -> :sswitch_0
    .end sparse-switch
.end method
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-boolean v7, p0, Landroid/widget/TextView;->mInternalDiscardNextActionUp:Z
    ...
    .line 7963
    :cond_3
    iput-boolean v9, p0, Landroid/widget/TextView;->mInternalDiscardNextActionUp:Z
...
.method public onYlPrivateIMECommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    .line 6052
    const-string v9, "YULONG_IME_SEND_TOUCH_EVENT"
    ...
    instance-of v9, v3, Landroid/view/ViewRootImpl;
    ...
    invoke-virtual {v9}, Landroid/widget/Editor;->hideInsertionPointCursorControllerP()V
    ...
    const-string v10, "getYLWindowFrame"
    ...
    invoke-virtual {v1, v7, v9}, Landroid/view/MotionEvent;->setLocation(FF)V
    ...
    invoke-virtual {v1, v7, v9}, Landroid/view/MotionEvent;->offsetLocation(FF)V
    ...
    const-string v9, "enqueueInputEvent"
    ...
    .end local v6           #winFrame:Landroid/graphics/Rect;
    :cond_7
    const-string v9, "YULONG_IME_SEND_BEGIN_INPUT_EVENT"
    ...
    .line 6109
    :cond_9
    const-string v9, "YULONG_IME_SEND_BEGIN_HANDWRITE_EVENT"
    ...
    .line 6112
    :cond_a
    const-string v9, "YULONG_IME_SEND_END_HANDWRITE_EVENT"
    ...
    .line 6113
    iput-boolean v7, p0, Landroid/widget/TextView;->mYlHandWriteOpened:Z
    ...
    .line 6115
    :cond_b
    const-string v9, "YULONG_IME_SEND_OPEN_EDITMENU_EVENT"
    ...
    .line 6120
    :cond_d
    const-string v9, "YULONG_IME_SEND_OPEN_CLIPBOARD_EVENT"
