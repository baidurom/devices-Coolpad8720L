...
.field private static final WEBCORE_DEADLOCK:I = 0x91
...
.field private mInWaitMessageForUiThreadSync:Z
...
.method private declared-synchronized sendMessageToUiThreadSync(Landroid/os/Message;)V
    ...
    iput-boolean v1, p0, Landroid/webkit/CallbackProxy;->mInWaitMessageForUiThreadSync:Z
    :try_end_1
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-boolean v4, v0, Landroid/webkit/CallbackProxy;->mInWaitMessageForUiThreadSync:Z
    ...
    const-string v10, "handleMessage messagesBlocked and mInWaitMessageForUiThreadSync, should call notify"
    ...
    .line 337
    .local v37, finishedUrl:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 344
    .end local v37           #finishedUrl:Ljava/lang/String;
    :sswitch_2
    move-object/from16 v0, p0
    ...
    .line 369
    .local v30, cancelMsg:Landroid/os/Message;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;

    move-result-object v4

    const-string v10, "continueMsg"
    ...
    .line 371
    .local v32, continueMsg:Landroid/os/Message;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v4, v10, v0, v1}, Landroid/webkit/WebViewClient;->onTooManyRedirects(Landroid/webkit/WebView;Landroid/os/Message;Landroid/os/Message;)V
    ...
    .line 381
    .end local v30           #cancelMsg:Landroid/os/Message;
    .end local v32           #continueMsg:Landroid/os/Message;
    :sswitch_6
    move-object/from16 v0, p0
    ...
    .line 385
    .local v36, failUrl:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v36           #failUrl:Ljava/lang/String;
    ...
    check-cast v38, Landroid/webkit/HttpAuthHandler;

    .line 417
    .local v38, handler:Landroid/webkit/HttpAuthHandler;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 425
    .end local v38           #handler:Landroid/webkit/HttpAuthHandler;
    ...
    new-instance v39, Landroid/webkit/JsDialogHelper;
    ...
    .line 606
    .local v39, helper:Landroid/webkit/JsDialogHelper;
    move-object/from16 v0, p0
    ...
    .line 614
    .end local v39           #helper:Landroid/webkit/JsDialogHelper;
    ...
    .line 617
    .local v56, res:Landroid/webkit/JsResult;
    move-object/from16 v0, p0
    ...
    .line 618
    invoke-virtual/range {v56 .. v56}, Landroid/webkit/JsResult;->confirm()V
    ...
    .line 620
    :cond_c
    invoke-virtual/range {v56 .. v56}, Landroid/webkit/JsResult;->cancel()V

    goto :goto_5

    .line 627
    .end local v55           #receiver:Landroid/webkit/CallbackProxy$JsResultReceiver;
    .end local v56           #res:Landroid/webkit/JsResult;
    :sswitch_1c
    move-object/from16 v0, p0
    ...
    .end local v27           #args:Ljava/lang/String;
    .end local v53           #realm:Ljava/lang/String;
    :sswitch_27
    move-object/from16 v0, p0
    ...
    invoke-virtual {v4, v10}, Landroid/webkit/WebViewClient;->onWebcoreDeadlock(Landroid/webkit/WebView;)V
