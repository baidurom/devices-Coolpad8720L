...
.field static final YULONG_FLAG_WEBVIEW:Ljava/lang/String; = "yulongWebView"
...
.field private mYulongWebView:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/webkit/WebViewCore;Landroid/webkit/CallbackProxy;Landroid/webkit/WebSettingsClassic;Ljava/util/Map;)V
    ...
    .line 1118
    iput-boolean v3, p0, Landroid/webkit/BrowserFrame;->mFirstRun:Z

    .line 1122
    iput-boolean v4, p0, Landroid/webkit/BrowserFrame;->mYulongWebView:Z
...
.method private getFile(Ljava/lang/String;[BII)I
    ...
    .local v2, size:I
    :try_start_0
    invoke-direct {p0, p1}, Landroid/webkit/BrowserFrame;->getInputStream(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    .line 821
    invoke-virtual {v4, p2, p3, v2}, Ljava/io/InputStream;->read([BII)I
...
.method private getInputStream(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    const-string v3, "BrowserFrame getInputStream: uri="
    ...
    const-string v1, "content://browser/upload"
    ...
    const-string v3, "BrowserFrame upload file :"
...
.method private getRawResFilename(I)Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0}, Landroid/webkit/BrowserFrame;->inYulongWebview()Z
    ...
    const-string/jumbo v1, "yulong:getinretrymode"

    invoke-virtual {v0, v1}, Landroid/webkit/CallbackProxy;->shouldOverrideUrlLoading(Ljava/lang/String;)Z
    ...
    const-string v2, "getRawResFilename: "
...
.method private inYulongWebview()Z
    .locals 3
    ...
    .line 1128
    iget-boolean v0, p0, Landroid/webkit/BrowserFrame;->mFirstRun:Z
    ...
    const-string/jumbo v2, "yulongWebView"

    invoke-virtual {v0, v2}, Landroid/webkit/WebSettingsClassic;->getProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/webkit/BrowserFrame;->mYulongWebView:Z

    .line 1130
    iput-boolean v1, p0, Landroid/webkit/BrowserFrame;->mFirstRun:Z
    ...
    const-string v2, "inYulongWebview: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Landroid/webkit/BrowserFrame;->mYulongWebView:Z
    ...
    .line 1133
    :cond_0
    iget-boolean v0, p0, Landroid/webkit/BrowserFrame;->mYulongWebView:Z
...
.method private maybeSavePassword([BLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v5}, Landroid/net/WebAddress;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v2}, Landroid/webkit/WebViewDatabaseClassic;->getUsernamePassword(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-virtual {v5, v2, p2, p3}, Landroid/webkit/WebViewDatabaseClassic;->setUsernamePassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v2, p2, p3, v6}, Landroid/webkit/CallbackProxy;->onSavePassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)Z
    :try_end_0
...
.method private reportError(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v1}, Landroid/net/http/ErrorStrings;->getString(ILandroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "yulong:setinretrymode:"
    ...
    .line 384
    .local v0, retryCheck:Ljava/lang/String;
    if-eqz p3, :cond_2
    ...
    invoke-virtual {v1, v0}, Landroid/webkit/CallbackProxy;->shouldOverrideUrlLoading(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, p1, p2, p3}, Landroid/webkit/CallbackProxy;->onReceivedError(ILjava/lang/String;Ljava/lang/String;)V
