...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/telephony/CallManager$AudioModeWorker;
    }
.end annotation
...
.field private static final SET_AUDIO_MODE:I = 0x1

.field private static final SET_AUDIO_MODE_STOP:I = 0x2

.field private static final VDBG:Z = true


# instance fields
.field private mAudioModeHandler:Landroid/os/Handler;

.field private mAudioModeThread:Lcom/android/internal/telephony/CallManager$AudioModeWorker;
...
.method private constructor <init>()V
    ...
    .line 1998
    iput-object v1, p0, Lcom/android/internal/telephony/CallManager;->mAudioModeThread:Lcom/android/internal/telephony/CallManager$AudioModeWorker;
    ...
    .line 184
    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->makeAudioModeLooper()V
...
.method private canDial(Lcom/android/internal/telephony/Phone;)Z
    ...
    :goto_0
    invoke-static {}, Lcom/yulong/android/modemservice/CPPhoneProperties;->isDualPhoneCallSupport()Z
...
.method public static getModeExt(Landroid/media/AudioManager;)I
    .locals 6
    ...
    .line 2103
    .local v1, getModeExt:Ljava/lang/reflect/Method;
    const/4 v2, 0x0
    ...
    .line 2113
    .end local v1           #getModeExt:Ljava/lang/reflect/Method;
    :goto_0
    return v2
...
.method static declared-synchronized setAudioModeForThread(Landroid/content/Context;I)V
    .locals 6
    .parameter "context"
    .parameter "mode"
    ...
    .prologue
    .line 2054
    const-class v3, Lcom/android/internal/telephony/CallManager;
    ...
    const-string v5, "audioManager.setAudioModeForThread begin: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    invoke-static {p1}, Lcom/android/internal/telephony/CallManager;->audioModeToString(I)Ljava/lang/String;
    ...
    .line 2057
    invoke-static {v0}, Lcom/android/internal/telephony/CallManager;->getModeExt(Landroid/media/AudioManager;)I
    ...
    const-string v5, "audioManager.setAudioModeForThread end: "
    ...
    invoke-static {v5}, Lcom/android/internal/telephony/CallManager;->audioModeToString(I)Ljava/lang/String;
    ...
    const-string v4, "requestAudioFocus on STREAM_RING"
    ...
    invoke-virtual {v0, v2, v4}, Landroid/media/AudioManager;->requestAudioFocusForCall(II)V
    ...
    const-string v4, "requestAudioFocus on STREAM_VOICE_CALL"
...
.method private unregisterForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    const-string v1, "CallManager unregisterForPhoneStates"
...
.method public dial(Lcom/android/internal/telephony/Phone;Ljava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/Connection;->hangup()V
...
.method public getServiceState()I
    ...
    const-string v6, "getServiceState : resultState = "
...
.method public getStatePreferOffHook()Lcom/android/internal/telephony/PhoneConstants$State;
    .locals 5
...
.method public makeAudioModeLooper()V
    .locals 2

    .prologue
    .line 2005
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mAudioModeThread:Lcom/android/internal/telephony/CallManager$AudioModeWorker;
    ...
    .line 2008
    :cond_0
    new-instance v0, Lcom/android/internal/telephony/CallManager$AudioModeWorker;

    const-string v1, "AudioMode"

    invoke-direct {v0, p0, v1}, Lcom/android/internal/telephony/CallManager$AudioModeWorker;-><init>(Lcom/android/internal/telephony/CallManager;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/internal/telephony/CallManager;->mAudioModeThread:Lcom/android/internal/telephony/CallManager$AudioModeWorker;

    .line 2009
    new-instance v0, Lcom/android/internal/telephony/CallManager$2;

    iget-object v1, p0, Lcom/android/internal/telephony/CallManager;->mAudioModeThread:Lcom/android/internal/telephony/CallManager$AudioModeWorker;

    invoke-virtual {v1}, Lcom/android/internal/telephony/CallManager$AudioModeWorker;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/internal/telephony/CallManager$2;-><init>(Lcom/android/internal/telephony/CallManager;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/internal/telephony/CallManager;->mAudioModeHandler:Landroid/os/Handler;
...
.method public sendAudioModeMsg(I)V
    .locals 4
    .parameter "mode"
    ...
    .line 2034
    iget-object v1, p0, Lcom/android/internal/telephony/CallManager;->mAudioModeHandler:Landroid/os/Handler;
...
.method public setAudioMode()V
    ...
    .line 420
    .local v2, mode:I
    sget-object v4, Lcom/android/internal/telephony/CallManager$3;->$SwitchMap$com$android$internal$telephony$PhoneConstants$State:[I

    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->getStatePreferOffHook()Lcom/android/internal/telephony/PhoneConstants$State;
    ...
    :cond_1
    :goto_1
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/CallManager;->sendAudioModeMsg(I)V
    ...
    const-string v6, "sendAudioModeMsg ="
...
.method public startDtmf(C)Z
    ...
    invoke-interface {v1, v2, v4, v4, v3}, Lcom/android/internal/telephony/Phone;->sendBurstDtmf(Ljava/lang/String;IILandroid/os/Message;)V
...
.method public toString()Ljava/lang/String;
    ...
    const-string v5, "########### Dump CallManager ############"
