...
.method static synthetic access$1700(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationProviderProxy;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1702(Lcom/android/server/LocationManagerService;Lcom/android/server/location/LocationProviderProxy;)Lcom/android/server/location/LocationProviderProxy;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1800(Lcom/android/server/LocationManagerService;)Ljava/util/HashMap;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$200(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationProviderProxy;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2000(Lcom/android/server/LocationManagerService;Lcom/android/server/location/LocationProviderInterface;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2102(Lcom/android/server/LocationManagerService;Lcom/android/server/location/GeocoderProxy;)Lcom/android/server/location/GeocoderProxy;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2200(Lcom/android/server/LocationManagerService;Lcom/android/server/location/LocationProviderInterface;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2300(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationProviderProxy;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2400(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationProviderProxy;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2700(Lcom/android/server/LocationManagerService;)Ljava/util/HashMap;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$300(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/GeocoderProxy;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$400(Lcom/android/server/LocationManagerService;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$402(Lcom/android/server/LocationManagerService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private loadProvidersLocked()V
    ...
    .prologue
    .line 418
    new-instance v11, Lcom/android/server/location/PassiveProvider;

    move-object/from16 v0, p0

    invoke-direct {v11, v0}, Lcom/android/server/location/PassiveProvider;-><init>(Landroid/location/ILocationManager;)V

    .line 419
    .local v11, passiveProvider:Lcom/android/server/location/PassiveProvider;
    move-object/from16 v0, p0

    invoke-direct {v0, v11}, Lcom/android/server/LocationManagerService;->addProviderLocked(Lcom/android/server/location/LocationProviderInterface;)V
    ...
    invoke-virtual {v11}, Lcom/android/server/location/PassiveProvider;->getName()Ljava/lang/String;
    ...
    iput-object v11, v0, Lcom/android/server/LocationManagerService;->mPassiveProvider:Lcom/android/server/location/PassiveProvider;

    .line 423
    new-instance v10, Lcom/android/server/location/GpsLocationProvider;
    ...
    invoke-direct {v10, v2, v0, v3}, Lcom/android/server/location/GpsLocationProvider;-><init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V

    .line 426
    .local v10, gpsProvider:Lcom/android/server/location/GpsLocationProvider;
    ...
    .line 427
    invoke-virtual {v10}, Lcom/android/server/location/GpsLocationProvider;->getGpsStatusProvider()Landroid/location/IGpsStatusProvider;
    ...
    .line 428
    invoke-virtual {v10}, Lcom/android/server/location/GpsLocationProvider;->getNetInitiatedListener()Landroid/location/INetInitiatedListener;
    ...
    .line 449
    .local v17, providerPackageNames_baidu:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    new-instance v16, Ljava/util/ArrayList;

    invoke-direct/range {v16 .. v16}, Ljava/util/ArrayList;-><init>()V

    .line 450
    .local v16, providerPackageNames_amap:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    new-instance v18, Ljava/util/ArrayList;

    invoke-direct/range {v18 .. v18}, Ljava/util/ArrayList;-><init>()V

    .line 451
    .local v18, providerPackageNames_google:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const v2, 0x107002d
    ...
    .line 453
    .local v13, pkgs_baidu:[Ljava/lang/String;
    const v2, 0x1070045
    ...
    .line 455
    .local v12, pkgs_amap:[Ljava/lang/String;
    const v2, 0x1070044
    ...
    .line 457
    .local v14, pkgs_google:[Ljava/lang/String;
    const v2, 0x111002b
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/server/location/GeofenceProxy;->createAndBind(Landroid/content/Context;IIILandroid/os/Handler;Landroid/location/IGpsGeofenceHardware;)Lcom/android/server/location/GeofenceProxy;

    move-result-object v15

    .line 589
    .local v15, provider:Lcom/android/server/location/GeofenceProxy;
    if-nez v15, :cond_5
    ...
    .line 520
    .end local v15           #provider:Lcom/android/server/location/GeofenceProxy;
    :cond_6
    move-object/from16 v0, p0
