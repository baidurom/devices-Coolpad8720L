...
.method static synthetic access$1500(Lcom/android/server/power/PowerManagerService;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1600(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/DisplayPowerRequest;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1700(Lcom/android/server/power/PowerManagerService;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2300(Lcom/android/server/power/PowerManagerService;)Ljava/lang/Runnable;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3300(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/display/DisplayManagerService;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3700(Lcom/android/server/power/PowerManagerService;)Landroid/app/AlarmManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3702(Lcom/android/server/power/PowerManagerService;Landroid/app/AlarmManager;)Landroid/app/AlarmManager;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3800(Lcom/android/server/power/PowerManagerService;)Landroid/app/PendingIntent;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3900(Lcom/android/server/power/PowerManagerService;)I
    .locals 1
    .parameter "x0"
...
.method private acquireWakeLockInternal(Landroid/os/IBinder;ILjava/lang/String;Landroid/os/WorkSource;II)V
    ...
    invoke-virtual {v0}, Lcom/android/server/power/PowerManagerService$WakeLock;->toString()Ljava/lang/String;
...
.method private updateDisplayPowerStateLocked(I)V
    ...
    .line 1974
    invoke-direct {p0, v3}, Lcom/android/server/power/PowerManagerService;->updateButtonLightLock(I)V
...
.method private updateIsPoweredLocked(I)V
    ...
    invoke-virtual {v0, v4, v9, v10}, Lcom/android/server/power/WirelessChargerDetector;->update(ZII)Z
    ...
    .line 1434
    .restart local v6       #dockedOnWirelessCharger:Z
    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J
...
.method private updateSettingsLocked()V
    ...
    .line 690
    iget v3, p0, Lcom/android/server/power/PowerManagerService;->mTotalChgDelaySetting:I
    ...
    invoke-virtual {v3, v6, v11, v12}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z
    ...
    invoke-static {v2, v3, v4, v10}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {v2, v3, v4, v10}, Landroid/provider/Settings$System;->getFloatForUser(Landroid/content/ContentResolver;Ljava/lang/String;FI)F
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    iget v8, p0, Lcom/android/server/power/PowerManagerService;->mButtonLightTime:I
    ...
    invoke-virtual {v6, v0, v1, v2}, Landroid/os/Handler;->sendMessageAtTime(Landroid/os/Message;J)Z
...
.method private userActivityNoUpdateLocked(JIII)Z
    ...
    const-string v4, "userActivityNoUpdateLocked: mProximityPositive="
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v9, "  mTotalChgDelaySetting ="

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v9, p0, Lcom/android/server/power/PowerManagerService;->mTotalChgDelaySetting:I
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    .line 570
    .local v13, btnIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 634
    .end local v13           #btnIntent:Landroid/content/Intent;
    .end local v14           #filter:Landroid/content/IntentFilter;
