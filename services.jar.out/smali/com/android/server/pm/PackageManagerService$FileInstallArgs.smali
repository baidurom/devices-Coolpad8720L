...
.method private cleanUp()Z
    ...
    .line 8397
    .local v14, sourceDir:Ljava/lang/String;
    ...
    .line 8403
    .local v11, publicSourceDir:Ljava/lang/String;
    if-eqz v14, :cond_5

    const-string v17, "/system/presetapp"
    ...
    .line 8407
    .local v16, strDelPath:Ljava/lang/String;
    const/4 v10, 0x0
    ...
    #calls: Lcom/android/server/pm/PackageManagerService;->parsePackageName(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)Ljava/lang/String;
    invoke-static {v0, v10, v4}, Lcom/android/server/pm/PackageManagerService;->access$3500(Lcom/android/server/pm/PackageManagerService;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    const-string v19, "YLLOG: delete systemPresetapp apk Name = "
    ...
    .line 8429
    sget-object v17, Lcom/android/server/pm/PackageManagerService;->mDelApkPackagesName:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/pm/PackageManagerService;->writeDelAPK()V
    :try_end_2
    ...
    .end local v16           #strDelPath:Ljava/lang/String;
    :cond_0
    :goto_2
    if-eqz v11, :cond_2
    ...
    .line 8460
    .local v12, publicSourceFile:Ljava/io/File;
    ...
    const-string v19, "Package public source "
    ...
    .line 8468
    .end local v12           #publicSourceFile:Ljava/io/File;
    :cond_2
    move-object/from16 v0, p0
    ...
    .line 8470
    .local v8, nativeLibraryFile:Ljava/io/File;
    invoke-static {v8}, Lcom/android/internal/content/NativeLibraryHelper;->removeNativeBinariesFromDirLI(Ljava/io/File;)Z
    ...
    const-string v19, "Couldn\'t delete native library directory "
    ...
    .line 8476
    .end local v8           #nativeLibraryFile:Ljava/io/File;
    :cond_3
    return v13
    ...
    .restart local v16       #strDelPath:Ljava/lang/String;
    :cond_4
    :try_start_3
    const-string v17, "PackageManager"
    ...
    const-string v19, "Failed adding asset path:"
    ...
    const-string v19, "Unable to read AndroidManifest.xml of "
    ...
    const-string v19, "Package source "
