...
.method private parsePdu([B)V
    ...
    const-string v8, "createFromPdu pdu == null || pdu.length == 0, return null"
    ...
    const-string v9, "parsePdu length = "
    ...
    const-string v9, "parsePdu bearerDataLength = "
...
.method private parsePduFromEfRecord([B)V
    ...
    const-string v22, "parsePduFromEfRecord pdu == null || pdu.length == 0, return null"
    ...
    const-string v23, "parsePduFromEfRecord pdu = "
...
.method private parsePduFromEfRecordpri([B)V
    ...
    const-string v10, "parsePduFromEfRecordpri pdu == null || pdu.length == 0, return null"
...
.method private static privateGetSubmitPdu(Ljava/lang/String;ZLcom/android/internal/telephony/cdma/sms/UserData;)Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;
    ...
    const-string v15, "enter privateGetSubmitPdu"
    ...
    iput v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->messageType:I
    ...
    iput v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->messageId:I
    ...
    iput-boolean v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->userAckReq:Z

    .line 1490
    const/4 v14, 0x0

    iput-boolean v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->readAckReq:Z

    .line 1491
    const/4 v14, 0x0

    iput-boolean v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->reportReq:Z
    ...
    .line 1494
    const-string v14, "yulong.mms.priority"
    ...
    iput v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->priority:I

    .line 1496
    iget v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->priority:I
    ...
    iput-boolean v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->priorityIndicatorSet:Z

    .line 1499
    :cond_1
    const-string v14, "yulong.mms.callback.number"
    ...
    .line 1502
    .local v11, sCallBackNumber:Ljava/lang/String;
    if-eqz v11, :cond_2
    ...
    const-string v16, "the sCallBackNumber = "
    ...
    .line 1507
    .local v3, callbackNumber:Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;
    ...
    .line 1514
    .end local v3           #callbackNumber:Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;
    .end local v11           #sCallBackNumber:Ljava/lang/String;
    :cond_2
    :goto_1
    const/16 v14, 0xf7

    iput v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->validityPeriodRelative:I
    ...
    invoke-static {v14}, Lcom/android/internal/telephony/cdma/SmsMessage;->getValidityPeriodRelative(Landroid/content/Context;)I
    ...
    .line 1518
    :cond_3
    iget v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->validityPeriodRelative:I
    ...
    iput-boolean v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->validityPeriodRelativeSet:Z
    ...
    invoke-static {v14, v15}, Landroid/telephony/Rlog;->isLoggable(Ljava/lang/String;I)Z
    ...
    const-string v16, "MO (encoded) BearerData = "
    ...
    const-string v16, "MO raw BearerData = \'"
    ...
    const-string v15, "encodedBearerData is null"
    ...
    :cond_6
    iput v10, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->priority:I
    ...
    iget-boolean v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->hasUserDataHeader:Z

    if-eqz v14, :cond_9

    iget-object v14, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->userData:Lcom/android/internal/telephony/cdma/sms/UserData;

    iget-object v14, v14, Lcom/android/internal/telephony/cdma/sms/UserData;->userDataHeader:Lcom/android/internal/telephony/SmsHeader;
    ...
    iget v12, v14, Lcom/android/internal/telephony/SmsHeader$PortAddrs;->destPort:I

    .line 1541
    .local v12, tel_service_id:I
    const/16 v14, 0x1003
    ...
    .line 1550
    .end local v12           #tel_service_id:I
    :cond_9
    const-string v14, "SmsMessage"
    ...
    const-string v16, "privateGetSubmitPdu teleservice = "
    ...
    iput v14, v7, Lcom/android/internal/telephony/cdma/sms/SmsEnvelope;->messageType:I

    .line 1553
    iput v13, v7, Lcom/android/internal/telephony/cdma/sms/SmsEnvelope;->teleService:I
    ...
    iput v14, v7, Lcom/android/internal/telephony/cdma/sms/SmsEnvelope;->bearerReply:I
    ...
    iget v14, v7, Lcom/android/internal/telephony/cdma/sms/SmsEnvelope;->teleService:I

    invoke-virtual {v5, v14}, Ljava/io/DataOutputStream;->writeInt(I)V
    ...
    .line 1573
    iget v14, v4, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->digitMode:I

    invoke-virtual {v5, v14}, Ljava/io/DataOutputStream;->write(I)V

    .line 1574
    iget v14, v4, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->numberMode:I

    invoke-virtual {v5, v14}, Ljava/io/DataOutputStream;->write(I)V

    .line 1575
    iget v14, v4, Lcom/android/internal/telephony/SmsAddress;->ton:I

    invoke-virtual {v5, v14}, Ljava/io/DataOutputStream;->write(I)V

    .line 1576
    iget v14, v4, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->numberPlan:I

    invoke-virtual {v5, v14}, Ljava/io/DataOutputStream;->write(I)V

    .line 1577
    iget v14, v4, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->numberOfDigits:I
    ...
    invoke-virtual {v5, v14, v15, v0}, Ljava/io/DataOutputStream;->write([BII)V
    ...
    invoke-virtual {v5, v6, v14, v15}, Ljava/io/DataOutputStream;->write([BII)V
    ...
    iput-object v14, v9, Lcom/android/internal/telephony/SmsMessageBase$SubmitPduBase;->encodedMessage:[B

    .line 1589
    const/4 v14, 0x0

    iput-object v14, v9, Lcom/android/internal/telephony/SmsMessageBase$SubmitPduBase;->encodedScAddress:[B
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v16, "creating SubmitPdu failed: "
...
.method public parseCdmaAddress([BI)Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;
    ...
    invoke-virtual {v6, v7}, Lcom/android/internal/util/BitwiseInputStream;->read(I)I
    ...
    const-string v8, "parseCdmaAddress numberOfDigits is too long "
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/cdma/SmsMessage;->convertDtmfToAscii(B)B
    ...
    const-string v9, "parseCdmaAddress failed: "
    ...
    const-string v8, "TODO: Originating Addr is email id"
    ...
    const-string v9, "Originating Addr="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    invoke-virtual {v0}, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->toString()Ljava/lang/String;
    ...
    const-string v8, "TODO: Originating Addr is data network address"
    ...
    const-string v8, "Originating Addr is of incorrect type"
...
.method public parseSms()V
    ...
    const-string v2, "yangmingming userData = "
    ...
    const-string v1, "parseSms  messageBody = NULL userData = NULL"
