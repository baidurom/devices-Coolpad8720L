...
.field private static final EVENT_CLOSE_CHANNEL_DONE:I = 0xf

.field private static final EVENT_EXCHANGE_APDU_DONE:I = 0xd

.field private static final EVENT_GET_ATR_DONE:I = 0x11
...
.field private static final EVENT_OPEN_CHANNEL_DONE:I = 0xe
...
.method private broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "yulong.intent.action.DUAL_SIM_STATE_CHANGED"
    ...
    invoke-virtual {v3, v5}, Lcom/yulong/android/internal/telephony/PhoneModeManager;->getSlotIdByPhoneId(I)I
    ...
    invoke-static {v1, v3, v5}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
...
.method private setExternalState(Lcom/android/internal/telephony/IccCardConstants$State;Z)V
    ...
    .line 494
    .local v1, tempOldState:Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    .line 502
    .local v0, cardInsertState:Ljava/lang/String;
    :goto_1
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "set sim/ruim state = "
    ...
    .line 510
    .end local v0           #cardInsertState:Ljava/lang/String;
    .end local v1           #tempOldState:Lcom/android/internal/telephony/IccCardConstants$State;
    :catchall_0
    move-exception v2
    ...
    .line 499
    .restart local v1       #tempOldState:Lcom/android/internal/telephony/IccCardConstants$State;
    :cond_2
    :try_start_1
    ...
    .restart local v0       #cardInsertState:Ljava/lang/String;
    goto :goto_1
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/uicc/IccCardProxy;->getIccStateReason(Lcom/android/internal/telephony/IccCardConstants$State;)Ljava/lang/String;
...
.method private updateExternalState()V
    ...
    .line 347
    const-string v0, "updateExternalState,mUiccCard is null"
...
.method private updateIccAvailability()V
    ...
    const-string v5, "Icc changed. Reregestering. phoneid = "
    ...
    invoke-virtual {v3, v5}, Lcom/android/internal/telephony/uicc/UiccController;->getDualUiccCard(I)Lcom/android/internal/telephony/uicc/UiccCard;
...
.method public getAtr(Landroid/os/Message;)V
    ...
    .prologue
    .line 892
    const-string v0, "get Answer to Reset..."
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v4, "icccard enter handleMessage "
    ...
    invoke-direct {p0, v3}, Lcom/android/internal/telephony/uicc/IccCardProxy;->loge(Ljava/lang/String;)V
    ...
    .line 242
    iget-boolean v3, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mInitialized:Z
    ...
    .line 252
    :pswitch_4
    iget-object v3, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mAbsentRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-direct {p0, v3, v5}, Lcom/android/internal/telephony/uicc/IccCardProxy;->broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 268
    :pswitch_9
    iget-object v3, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mNetworkLockedRegistrants:Landroid/os/RegistrantList;
    ...
    const-string v5, "CP_COMM: Error in get pin&puk valid count with exception"
    ...
    iput v3, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPinPukCount:I
...
.method public queryPINPUKValidCount(ILandroid/os/Message;)V
    ...
    const-string v1, "enter queryPINPUKValidCount..."
    ...
    invoke-interface {v0, p1, v1}, Lcom/android/internal/telephony/CommandsInterface;->queryPINPUKValidCount(ILandroid/os/Message;)V
...
.method public setIccCardLock()Z
    ...
    .line 842
    const-string v7, "enter setIccCardLock..."
    ...
    invoke-interface {v7, v11, v0}, Lcom/android/internal/telephony/CommandsInterface;->queryPINPUKValidCount(ILandroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 854
    iget v7, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPinPukCount:I
    ...
    :try_start_3
    const-string v7, "CP_COMM: [setIccCardLock] get pincount failed"
    ...
    invoke-virtual {v7}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getIccFdnEnabled()Z
    ...
    .line 865
    .local v6, retValue:Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, v7, v5, v10}, Lcom/android/internal/telephony/uicc/IccCardProxy;->setIccLockEnabled(ZLjava/lang/String;Landroid/os/Message;)V
    ...
    .end local v6           #retValue:Ljava/lang/Boolean;
    :cond_4
    move v7, v8
    ...
    .restart local v6       #retValue:Ljava/lang/Boolean;
    :cond_5
    move v7, v8
...
.method public supplyPin(Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v2, "enter supplyPin..."
...
.method public updateIccCardProxy(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    .locals 3
    .parameter "context"
    .parameter "ci"
