...
.field static final PAUSE_DELAY_FIRST_MILLIS:I = 0xfa0
...
.field public videoDisconnectCause:I
...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/DriverCall;Lcom/android/internal/telephony/gsm/GsmCallTracker;I)V
    ...
    iput v0, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->videoDisconnectCause:I
    ...
    .line 146
    iput-boolean v2, p0, Lcom/android/internal/telephony/Connection;->isQuickDial:Z

    .line 148
    sget v0, Lcom/android/internal/telephony/gsm/GsmConnection;->GSM_LINK:I

    iput v0, p0, Lcom/android/internal/telephony/Connection;->linkType:I

    .line 149
    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/android/internal/telephony/Connection;->contactID:J

    .line 150
    iput-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->isQuickDisconnect:Z
...
.method private setPostDialState(Lcom/android/internal/telephony/Connection$PostDialState;)V
    ...
    .line 889
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmConnection;->releaseWakeLock()V
...
.method compareTo(Lcom/android/internal/telephony/DriverCall;)Z
    ...
    const-string v4, "compareTo: address="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->mAddress:Ljava/lang/String;

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, ",cAddress="
...
.method disconnectCauseFromCode(I)Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    iget-object v1, v3, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPhone:Lcom/android/internal/telephony/gsm/GSMPhone;
    ...
    invoke-virtual {v3, v5, v4}, Lcom/android/internal/telephony/uicc/UiccController;->getDualUiccCardApplication(II)Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    .line 499
    :sswitch_6
    invoke-virtual {p0}, Lcom/android/internal/telephony/Connection;->isVideoCall()Z
    ...
    .line 500
    sget-object v3, Lcom/android/internal/telephony/Connection$DisconnectCause;->FALLBACK_VT:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    .line 505
    sget-object v3, Lcom/android/internal/telephony/Connection$DisconnectCause;->VT_RESOURCE_NOT_AVAIL:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    .line 510
    sget-object v3, Lcom/android/internal/telephony/Connection$DisconnectCause;->VT_BEARER_CAP_NOT_AUTHORIZED:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    .line 517
    sget-object v3, Lcom/android/internal/telephony/Connection$DisconnectCause;->VT_NO_ANSWER:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    .line 521
    sget-object v3, Lcom/android/internal/telephony/Connection$DisconnectCause;->VT_CALL_REJECTED:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    :cond_4
    :sswitch_b
    sget-object v3, Lcom/android/internal/telephony/Connection$DisconnectCause;->DIAL_MODIFIED_TO_USSD:Lcom/android/internal/telephony/Connection$DisconnectCause;

    goto :goto_0

    .line 527
    :sswitch_c
    sget-object v3, Lcom/android/internal/telephony/Connection$DisconnectCause;->DIAL_MODIFIED_TO_SS:Lcom/android/internal/telephony/Connection$DisconnectCause;

    goto :goto_0

    .line 530
    :sswitch_d
    sget-object v3, Lcom/android/internal/telephony/Connection$DisconnectCause;->DIAL_MODIFIED_TO_DIAL:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    .line 549
    iget-object v3, v1, Lcom/android/internal/telephony/gsm/GSMPhone;->mSST:Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;

    iget-object v3, v3, Lcom/android/internal/telephony/ServiceStateTracker;->mRestrictedState:Lcom/android/internal/telephony/RestrictedState;
...
.method public getPhoneId()I
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->getPhoneId()I
...
.method onDisconnect(Lcom/android/internal/telephony/Connection$DisconnectCause;)V
    ...
    .line 578
    iget-boolean v0, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->isQuickDisconnect:Z
...
.method onHangupLocal()V
    ...
    const-string v3, "[GSMConn] onHangupLocal,isVoice="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->isVoice:Z

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ",isQuickDisconnect="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->isQuickDisconnect:Z
    ...
    .line 383
    iget-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->isVoice:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->isQuickDisconnect:Z
    ...
    iget-object v1, v1, Lcom/android/internal/telephony/gsm/GsmCallTracker;->pendingMO:Lcom/android/internal/telephony/gsm/GsmConnection;

    if-nez v1, :cond_0

    .line 396
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmConnection;->onLocalDisconnect()V

    .line 399
    .end local v0           #connCount:I
    :cond_0
    return-void
.end method
...
.method onLocalDisconnect()V
    ...
    const-string v2, "[GSMConn] onLocalDisconnect"

    invoke-static {v1, v2}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 407
    iput-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->isQuickDisconnect:Z
    ...
    .line 413
    iput-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->mDisconnected:Z
    ...
    const-string v3, "[GSMConn] onLocalDisconnect: cause="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->mCause:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmConnection;->getConnectTime()J
    ...
    .line 420
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->mCause:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->mCause:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    const-string v2, "setting cause to "
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->internalClearDisconnected()V
    ...
    iput-object v2, v1, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mState:Lcom/android/internal/telephony/PhoneConstants$State;
    ...
    iget-object v1, v1, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mVoiceCallEndedRegistrants:Landroid/os/RegistrantList;
    ...
    .line 423
    .end local v0           #oldState:Lcom/android/internal/telephony/PhoneConstants$State;
    :cond_3
    ...
    .line 444
    .restart local v0       #oldState:Lcom/android/internal/telephony/PhoneConstants$State;
    :cond_4
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->mOwner:Lcom/android/internal/telephony/gsm/GsmCallTracker;
...
.method public setVoiceFlag(Z)V
    .locals 0
    .parameter "flag"

    .prologue
    .line 188
    iput-boolean p1, p0, Lcom/android/internal/telephony/gsm/GsmConnection;->isVoice:Z
