...
.field private static final TOUCH_PROTECT_SCREEN_DEBOUNCE_DELAY_MILLIS:J = 0xc8L
...
.field mFlashLightOn:I

.field mFlashLightPowerUp:Z
...
.method public constructor <init>()V
    ...
    .line 212
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->isShuttingDown:Z
    ...
    .line 354
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardLongPressed:Z

    .line 355
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightPowerUp:Z

    .line 356
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguradLongPressLock:I

    .line 357
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightOn:I

    .line 358
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerDownTimes:I
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    const v3, #android:array@config_physicalKeyVibePattern#t

    invoke-static {v2, v3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getLongIntArray(Landroid/content/res/Resources;I)[J

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPhysicalKeyVibePattern:[J

    .line 1172
    iget-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashlightReceiver:Landroid/content/BroadcastReceiver;

    new-instance v3, Landroid/content/IntentFilter;

    const-string v4, "yulong.intent.action.flashlight"
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardLongPressed:Z
    ...
    iput-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardLongPressed:Z
    ...
    iput v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightOn:I
    ...
    const-string v6, "open: mFlashLightOn="
    ...
    iget v6, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightOn:I
    ...
    const-string v6, ",mKeyguardLongPressed="
    ...
    iget-boolean v6, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardLongPressed:Z
    ...
    const-string v6, ",mKeyguradLongPressLock="
    ...
    iget v6, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguradLongPressLock:I
    ...
    iget v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightOn:I
    ...
    iget v5, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightOn:I
    ...
    const-string v3, "android.intent.action.FLASH_LIGHT"
    ...
    iget v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguradLongPressLock:I

    add-int/lit8 v5, v3, 0x1

    move-object/from16 v0, p0

    iput v5, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguradLongPressLock:I

    if-nez v3, :cond_c

    .line 2276
    const-string v3, "com.android.flashlight"

    const-string v5, "com.android.flashlight.FlashLight"
    ...
    const-string v6, "open flashlight: intent = "
    ...
    iput v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerDownTimes:I
    ...
    iget-object v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVibrator:Landroid/os/Vibrator;
    ...
    .line 2340
    .local v22, homekeyintent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 2342
    .end local v22           #homekeyintent:Landroid/content/Intent;
    :cond_11
    if-eqz v19, :cond_12
    ...
    .end local v18           #enableMonkey:I
    .end local v19           #enabletest:I
    :cond_14
    if-eqz p1, :cond_16
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    .line 4108
    const-string v17, "sys.yulong.flashlight"
    ...
    iput v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightOn:I

    .line 4109
    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightPowerUp:Z
    ...
    .line 4110
    const-string v17, "PhoneWindowManager"

    const-string v18, "FlashLightPowerUp Power up !"
    ...
    iput-boolean v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightPowerUp:Z
    ...
    iget v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFlashLightOn:I
    ...
    iget v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerDownTimes:I
    ...
    const-string v17, "com.android.intent.action.Close_FlashLight"
    ...
    const-string v19, "KEYCODE_POWER close flashlight: intent = "
    ...
    const-string v19, ", mFlashLightOn = "
    ...
    const-string v19, ", mPowerDownTimes = "
    ...
    iput v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerDownTimes:I
    ...
    invoke-virtual {v0, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->onWakeKeyWhenKeyguardShowingTq(I)V
    ...
    const-string v18, "interceptKeyBeforeQueueing: adjust STREAM_FM volume"
    ...
    .line 4384
    .local v14, power:Landroid/os/PowerManager;
    const/16 v17, 0x0
    ...
    .line 4388
    invoke-virtual {v14}, Landroid/os/PowerManager;->isRealyScreenOn()Z
    ...
    const-string v18, "result = 2 interceptPowerKey: FEATURE_POWERKEY_FORCE_SCREENON"
    ...
    const-string v19, "result power key  is "
    ...
    .line 4408
    .end local v14           #power:Landroid/os/PowerManager;
    :sswitch_4
    if-eqz v5, :cond_29
...
.method public layoutWindowLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Landroid/view/WindowManagerPolicy$WindowState;)V
    ...
    .local v20, unDockTop:I
    const/16 v18, 0x0

    .local v18, unContentTop:I
    const/16 v19, 0x0

    .local v19, unCurTop:I
    invoke-interface/range {p1 .. p1}, Landroid/view/WindowManagerPolicy$WindowState;->getAttrs()Landroid/view/WindowManager$LayoutParams;
...
.method public updateSettings()V
    ...
    .line 1409
    :cond_5
    const-string v8, "homekey_wakeup"
    ...
    iput v8, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomeKeyWakeUp:I
