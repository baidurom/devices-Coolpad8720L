...
.field private static CT_LAWMO_LEVEL_LOCK:Ljava/lang/String; = null

.field private static CT_LAWMO_LEVEL_UNLOCK:Ljava/lang/String; = null
...
.field private static final DM_LAWMO_LOCK_LEVEL:Ljava/lang/String; = "PROJECT2"

.field private static final DM_LOCK_ACTION:Ljava/lang/String; = "android.intent.action.DMLawmoLockDevice"

.field private static final DM_UNLOCK_ACTION:Ljava/lang/String; = "android.intent.action.DMLawmoUnLockDevice"
...
.field private static final THEME_CHANGED:Ljava/lang/String; = "android.intent.action.THEME_CHANGED"
...
.field private mIsOpenStatuBar:I
...
.field public mTouchProtectScreen:Lcom/android/internal/policy/impl/keyguard/TouchProtectScreen;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->CT_LAWMO_LEVEL_UNLOCK:Ljava/lang/String;

    .line 159
    const-string v0, "1"

    sput-object v0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->CT_LAWMO_LEVEL_LOCK:Ljava/lang/String;

    .line 160
    sput-boolean v1, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isDmLock:Z

    .line 226
    sput-boolean v1, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isFangdaoPattern:Z

    .line 227
    sput-boolean v1, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isRebootPassPattern:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)V
    ...
    .line 273
    iput-object v9, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->res:Landroid/content/res/Resources;
    ...
    invoke-static {v5}, Lcom/android/internal/policy/impl/keyguard/LockscreenSettingManager;->creatInstance(Landroid/content/Context;)Lcom/android/internal/policy/impl/keyguard/LockscreenSettingManager;
    ...
    .line 545
    const-string v5, "yulong.intent.action. REQUEST_RESULT_EXPAND "

    invoke-virtual {v1, v5}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 546
    const-string v5, "android.intent.action.THEME_CHANGED"

    invoke-virtual {v1, v5}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 548
    const-string v5, "android.intent.action.DMLawmoLockDevice"

    invoke-virtual {v1, v5}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 549
    const-string v5, "android.intent.action.DMLawmoUnLockDevice"
    ...
    iput-object v5, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->res:Landroid/content/res/Resources;
...
.method static synthetic access$1600(Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;)V
    ...
    .prologue
    .line 98
    invoke-direct {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->sendBroadCastToStatusBar()V

    return-void
.end method

.method static synthetic access$1700(Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;)Landroid/content/res/Resources;
    .locals 1
    .parameter "x0"

    .prologue
    .line 98
    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->res:Landroid/content/res/Resources;
...
.method static synthetic access$2400(Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private adjustStatusBarLocked()V
    ...
    const-string v3, "isShowStatuBar"

    invoke-static {v2, v3, v6}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v2

    iput v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mIsOpenStatuBar:I
    ...
    const-string v4, "adjustStatusBarLocked mIsOpenStatuBar = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mIsOpenStatuBar:I
    ...
    iget v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mIsOpenStatuBar:I
...
.method private doKeyguardLocked(Landroid/os/Bundle;)V
    ...
    .line 977
    iget-boolean v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mExternallyEnabled:Z

    if-nez v7, :cond_1

    sget-boolean v7, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isFangdaoPattern:Z

    if-nez v7, :cond_1

    sget-boolean v7, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isRebootPassPattern:Z

    if-nez v7, :cond_1

    sget-boolean v7, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isDmLock:Z
    ...
    .line 998
    :cond_1
    iget-object v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mKeyguardViewManager:Lcom/android/internal/policy/impl/keyguard/KeyguardViewManager;
    ...
    const-string v9, "dd.w doKeyguardLocked isKVMshowing = "
    ...
    .line 1002
    sget-boolean v5, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isDmLock:Z
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->showLocked(Landroid/os/Bundle;)V
    ...
    :goto_1
    iget-object v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mUpdateMonitor:Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;
    ...
    invoke-virtual {v7}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->getSimState()Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    .line 1026
    sget-boolean v5, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isFangdaoPattern:Z

    if-nez v5, :cond_5

    sget-boolean v5, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isRebootPassPattern:Z
    ...
    const-string v6, "doKeyguard: not showing because lockscreen is off but is fangdao"
...
.method private playSounds(Z)V
    ...
    const-string v2, "Play lock sounds"
...
.method private sendBroadCastToStatusBar()V
    ...
    const-string v6, ".........run sendBroadCastToStatusBar isStatusBarChangeBack = "
    ...
    const-string v4, "yulong.intent.action.Lockscreen.CHANGE_STATUBAR_BLACK"
    ...
    .line 1657
    .local v3, statusBarIntent_WALLPAPER:Landroid/content/Intent;
    const-string v4, "changeback"
    ...
    .end local v3           #statusBarIntent_WALLPAPER:Landroid/content/Intent;
    :cond_1
    const/4 v1, 0x1
...
.method private showFangdaoOrRebootPass()V
    ...
    .line 659
    invoke-direct {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->showKeyguardType()I
    ...
    .line 660
    sput-boolean v2, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isFangdaoPattern:Z
    ...
    .line 663
    sput-boolean v2, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isRebootPassPattern:Z
...
.method private showKeyguardType()I
    ...
    invoke-static {v2}, Lcom/android/internal/policy/impl/keyguard/YLClassProxy;->ISystemInterface_getShowKeyguardType(Ljava/lang/Object;)I
    :try_end_0
...
.method private showLocked(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/impl/keyguard/TouchProtectScreen;->show()V
...
.method public isSecure()Z
    ...
    const-string v2, "....................................................mLockPatternUtilsisSecure() = "
    ...
    const-string v2, "....................................................isFangdaoPattern1 = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-boolean v2, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isFangdaoPattern:Z
    ...
    const-string v2, "....................................................isRebootPassPattern1 = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-boolean v2, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isRebootPassPattern:Z
...
.method public keyguardDone(ZZ)V
    ...
    const-string v3, "mTouchProtectScreen.hide() is remove ="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mTouchProtectScreen:Lcom/android/internal/policy/impl/keyguard/TouchProtectScreen;
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/impl/keyguard/TouchProtectScreen;->hide()V
...
.method public onDmLock()V
    ...
    const-string v1, "dd.w KeyguardViewMediator onDmLock() "
    ...
    const-string v2, "dd.w KeyguardViewMediator onDmUnLock() isDmLock= "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-boolean v2, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isDmLock:Z
...
.method public onDmUnLock()V
    ...
    const-string v1, "dd.w KeyguardViewMediator onDmUnLock() "
...
.method public onScreenTurnedOff(I)V
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/impl/keyguard/TouchProtectScreen;->screenOff()V
    ...
    sget-boolean v1, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isFangdaoPattern:Z

    if-nez v1, :cond_3

    sget-boolean v1, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isRebootPassPattern:Z

    if-nez v1, :cond_3

    sget-boolean v1, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isDmLock:Z
...
.method public onScreenTurnedOn(Lcom/android/internal/policy/impl/keyguard/KeyguardViewManager$ShowListener;)V
    ...
    .line 785
    :cond_0
    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mTouchProtectScreen:Lcom/android/internal/policy/impl/keyguard/TouchProtectScreen;
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/keyguard/TouchProtectScreen;->screenOn()V
...
.method public onSystemReady()V
    ...
    const-string v2, "......isDMLock2 =1 "

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 617
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->onDmLock()V

    .line 618
    const-string v1, "TAG"

    const-string v2, "onDmLock"
    ...
    .line 639
    :goto_1
    invoke-direct {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->showFangdaoOrRebootPass()V
...
.method public refreshStatusBarLocked()V
    ...
    const-string v1, "...........................refreshStatusBarLocked()"
    ...
    const-string v1, "...........................refreshStatusBarLocked()1"
    ...
    const-string v1, "...........................refreshStatusBarLocked()2"
